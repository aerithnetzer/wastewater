...
def run_analysis(image_path):
    """
    Runs the analysis pipeline on the input image.
    ...
    plt.savefig(f"segmented_image.png{image_path_name}", bbox_inches="tight")
    ...
    plt.ylabel("WCSS")
    plt.savefig(f"elbow_curve{image_path_name}.png")
    ...
    plt.savefig(
        f"clustered_segments_with_color_{image_path_name}.png", bbox_inches="tight"
    )
    ...
    plt.tight_layout()
    plt.savefig(f"cluster_statistics_{image_path_name}.png", bbox_inches="tight")
    plt.savefig(f"cluster_statistics_{image_path_name}.png", bbox_inches="tight")


for image in os.listdir("images"):
    run_analysis(f"./test-photos/{image}")
